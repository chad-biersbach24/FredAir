...
export default function Combo(props) {
	...
	<div className="w-1/2">
		...
		<div className="relative mt-1">
			...
			afterLeave={() => setQuery('')}
			>
			<Combobox.Options className="z-[2] absolute w-full py-1 mt-1 overflow-auto text-base bg-white rounded-md shadow-lg max-h-60 ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
