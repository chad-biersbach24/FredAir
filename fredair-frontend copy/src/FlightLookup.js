	...
	return (
		<>
			<div className="text-white space-y-2">
				...
				/>
				<button
					class="bg-white/[0.25] hover:bg-white/[0.5] text-white font-bold py-2 w-1/3 rounded-md"
					onClick={openModal}>
					Search
				</button>
			</div>
				...
				<Dialog
					...
					<div className="min-h-screen px-4 text-center">
						...
						<Transition.Child
							...
							<div className="inline-block w-full max-w-md p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-white rounded-2xl">
								<Dialog.Title
									as="h3"
