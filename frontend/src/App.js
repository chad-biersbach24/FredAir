...
function App() {
	...
	const airports = [
		...
		{ id: 2, name: "Buffalo Niagara International Airport" },
		{ id: 3, name: "Charlotte Douglas International Airport" },
		{
			id: 4,
			name: "Hartsfield-Jackson Atlanta International Airport",
		},
		{ id: 5, name: "Dallas Fort Worth International Airport" },
		{ id: 6, name: "Dane County Regional Airport" },
	];
